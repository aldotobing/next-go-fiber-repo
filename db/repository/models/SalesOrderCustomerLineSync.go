...
// SalesOrderCustomerLineSync ...
type SalesOrderCustomerLineSync struct {
	...
	LoacationID    *string `json:"location_id"`
}

// SalesOrderCustomerLineSyncParameter ...
type SalesOrderCustomerLineSyncParameter struct {
...
var (
	// SalesOrderCustomerLineSyncOrderBy ...
	SalesOrderCustomerLineSyncOrderBy = []string{"def.id", "def.created_date"}
	// SalesOrderCustomerLineSyncOrderByrByString ...
	SalesOrderCustomerLineSyncOrderByrByString = []string{
		"def.id",
	}

	// SalesOrderCustomerLineSyncSelectStatement ...
	SalesOrderCustomerLineSyncSelectStatement = ` select 
	...
	// SalesOrderCustomerLineSyncWhereStatement ...
	SalesOrderCustomerLineSyncWhereStatement = `WHERE def.created_date IS not NULL`
)
